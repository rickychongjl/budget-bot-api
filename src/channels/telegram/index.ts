 ...
 *
 * Implements `MessageSender` (`core/shared/messaging.ts`) against the Telegram Bot API
 * and owns `infrastructure/database/schema/platform.ts` (`inbound_update`). The only module that knows
